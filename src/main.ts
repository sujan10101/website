const render = () => {
        ...
        <div class="contact-items">
          <div class="contact-item email-item">
            ...
            <div class="email-container">
              <input type="text" class="email-input" id="email-input" value="hello@sujankhadka.com" readonly>
          ...
          <div class="contact-item">
            ...
            <a href="https://github.com/sujankhadka" target="_blank" class="social-link">
          ...
          <div class="contact-item">
            ...
            <a href="https://www.linkedin.com/in/sujan101/" target="_blank" class="social-link">
              ...
              <span>linkedin.com/in/sujan101</span>
            </a>
          </div>
        </div>
      </div>
  ...
  const resumeIframe = document.getElementById('resume-iframe') as HTMLIFrameElement;
